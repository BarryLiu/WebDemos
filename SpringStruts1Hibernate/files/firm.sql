...
CREATE TABLE `dept` (
  ...
  `loc` varchar(45) DEFAULT NULL COMMENT '部门地址',
  PRIMARY KEY (`deptno`)
...
CREATE TABLE `emp` (
  ...
  `ename` varchar(45) DEFAULT NULL COMMENT '员工名称',
  `job` varchar(45) DEFAULT NULL COMMENT '工作',
  `mgr` int(11) DEFAULT NULL COMMENT '领导id',
...
-- Dump completed on 2015-12-20 22:25:59
