...
<html>
 <head>
	...
	<body onload="check(),ly()">
		<form action="/Y2_HR/recruit/employ!sqRegister" name="fm" method="post"  enctype="multipart/form-data">
		...
		<input type="hidden" name="engageResume.id" value="<s:property value="engageResume.id"/>"/>
			<table width="100%">
				...
				<tr>
					<td align="right">
						<input type="radio"  name="erid" value="释放简历" onclick="sf()">释放简历
						<input type="radio"  name="erid" value="申请录用" checked="checked" onclick="ly()">申请录用
