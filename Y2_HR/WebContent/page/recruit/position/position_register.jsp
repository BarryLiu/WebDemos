...
<%@include file="/page/header.jsp"%>
 	...
 	<script type="text/javascript">
		 ...
		 */		
 	    ...
 	    if(document.getElementById("thirdKindId").value=="0"){
 	       alert("请选择三级机构");
 	       return ;
 	       }
	...
	<body>
		...
		<form name="humanfileForm" method="post" action="/Y2_HR/recruit/position!addEmajorRelease" >
		
		<input type="hidden" name="emajorRelease.firstKindName" id="firstKindName" >
		<input type="hidden" name="emajorRelease.secondKindName" id="secondKindName" >
		<input type="hidden" name="emajorRelease.thirdKindName" id="thirdKindName" >
		<input type="hidden" name="emajorRelease.majorKindName" id="majorKindName" >
		<input type="hidden" name="emajorRelease.majorName" id="majorName" >
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td width="14%" class="TD_STYLE2">
					 ...
					 <s:select list="firsts" value="0" headerKey="0" headerValue="--请选择--"
						 listValue="firstKindName" listKey="firstKindId" theme="simple" 
						  name="emajorRelease.firstKindId" id="firstKindId"  class="SELECT_STYLE1" ></s:select>
					</td>
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<s:select list="majorKinds" value="0" headerKey="0" headerValue="--请选择--"
						 listValue="majorKindName" listKey="majorKindId" theme="simple" 
						  name="emajorRelease.majorKindId" id="majorKindId" class="SELECT_STYLE1"></s:select>
					</td>
					<td class="TD_STYLE1">
						职位名称
					</td>
					...
					<td   class="TD_STYLE2">
						 <input type="text" name="emajorRelease.humanAmount" id="humanAmount"  class="INPUT_STYLE2"  onkeyup='this.value=this.value.replace(/\D/gi,"")'>
					</td>
					<td class="TD_STYLE1">
						截止日期
					</td>
					<td   class="TD_STYLE2">
							  <input type="date" name="emajorRelease.deadline" readonly
				...
				<td class="TD_STYLE1">
					...
					<td  class="TD_STYLE2">
						 <input type="text" name="emajorRelease.register" value="${currUser.userTrueName }" class="INPUT_STYLE2">
					</td>
					<td class="TD_STYLE1">
						登记时间
					</td>
