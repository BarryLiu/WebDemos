...
<body>
	<form method="post" name="myfrm" action="/Y2_HR/page/profile/query_list.jsp">
		<table width="100%">
			<tr>
				<td><font color="black">您正在做的业务是：人力资源--人力资源档案管理--人力资源档案查询
				</font></td>
			</tr>
			<tr>
				<td align="right"><input type="submit" value="查询"
					...
					class="BUTTON_STYLE1" onclick="location.href='/Y2_HR/page/profile/query_keywords.jsp'">
					<input type="hidden" name="result" value="toQueryList" /></td>
			</tr>
		</table>
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr class="TR_STYLE1">
				...
				<td width="84%" class="TD_STYLE2"><s:select name="humanFile.firstKindId" list="firsts"
			...
			<tr class="TR_STYLE1">
				...
				<td width="84%" class="TD_STYLE2"><select
					name="humanFile.thirdKindId" class="SELECT_STYLE2" size="5"
					id="thirdKind">
						<option value="0" selected="selected">全部</option>
			...
			<tr>
				...
				<td width="84%" class="TD_STYLE2"><input type="text"
					name="utilBean.startDate" readonly style="width: 14%"
					class="INPUT_STYLE2" id="date_start"> 至 <input type="text"
					name="utilBean.endDate" readonly="readonly" style="width: 14%"
					class="INPUT_STYLE2" id="date_end"> <input type="hidden"
					name="utilBean.datePropertyName" value="registTime" /></td>
			</tr>
		</table>
	</form> 
</body>
