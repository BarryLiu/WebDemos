...
<html>
	<head>
		...
		$(document).ready(function(){
			$("#table_name").change(function(){
				...
				/* $.get("/Y2_HR/data/dataAction!loadCloumns",
						{"tableName":$(this).val()},
						function(x){
							alert();							
						}); */
		...
		function loadTableName(inpName){
			...
			document.getElementById("tableComment").value=tbName.options[tbName.selectedIndex].innerHTML;
		}
	...
	<body>
		<form action="/Y2_HR/data/dataAction!initExcel" method="post">
		
		<input type="hidden" id="toGoSJsp"	value="excel_locate">
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr class="TR_STYLE1">
					<td class="TD_STYLE1" colspan="4">
						请选择要导出的表格
						<input type="hidden" value="" id="tableComment" name="tableComment">
				...
				<tbody id="fields">
					<tr>
							...
							<s:iterator value="columns"> 
								<td class="TD_STYLE2">
									<input type="checkbox"  name="field" value="<s:property value="columnName"/>"  /> 
